...
#Area=2*(Length+Breadth): This line calculates the perimeter of the rectangle using the formula: Perimeter=2×(Length+Breadth). It adds the length (Length) and breadth (Breadth) of the rectangle, multiplies the sum by 2, and assigns the result to the variable Area.
Area=2*(Length+Breadth)

#print('Perimeter of the rectangle is:',Area): This line prints out the calculated perimeter of the rectangle. It uses the print() function to display the text "Perimeter of the rectangle is:" followed by the value of the Area variable.
print('Perimeter of the rectangle is:',Area)
